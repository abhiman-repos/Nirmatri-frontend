...
export default function KYCStatusPage() {
  ...
  useEffect(() => {
    ...
    const fetchKYC = async () => {
      ...
      try {
        ...
        const res = await fetch(`${API}/kyc/${SELLER_ID}/`);
  ...
  const handleFileUpload = async (docId: string, file: File | null) => {
    ...
    try {
      ...
      const res = await fetch(`${API}/kyc/upload/${SELLER_ID}/`, {
        method: "POST",
        body: formData
      });
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-4 md:p-8 transition-colors">
      <div className="max-w-6xl mx-auto">
        ...
        {/* KYC STATUS BANNER */}
        {/* ============================================ */}
        <div className={`rounded-xl shadow-sm border-2 p-6 md:p-8 mb-6 ${kycStatus === "approved"
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h2 className={`text-2xl font-bold mb-2 ${kycStatus === "approved"
              ...
              <p className={`mb-4 ${kycStatus === "approved"
              ...
              <div className="bg-white dark:bg-gray-800 rounded-full h-3 overflow-hidden mb-2">
                <div
                  className={`h-full transition-all duration-500 ${kycStatus === "approved" ? "bg-green-600" : "bg-blue-600"
                    }`}
