  ...
  return (
    <div style={styles.container}>
      <header style={styles.header}>
        ...
        <button style={styles.saveAllButton} onClick={() => saveData("all")}>
          <FiSave /> Save All
        </button>
      </header>
      ...
      <div style={styles.sectionsContainer}>
                      ...
                      style={
                        {
                          ...styles.radioCustom,
                          borderColor:
                            formData.gender === "Male" ? "#3b82f6" : "#d1d5db",
          ...
          {!editing.email ? (
            <div style={styles.displayContent}>
              <div style={styles.infoRow}>
                ...
                <span style={{ ...styles.infoValue, ...styles.emailValue }}>
                  {userData.email}
                </span>
              </div>
            </div>
        ...
        >
          ...
          {!editing.mobile ? (
            ...
            <div style={styles.editForm}>
              <div style={styles.formGroup}>
                <label htmlFor="mobile" style={styles.formLabel}>
                  Mobile Number
                </label>
                <input
                  type="tel"
